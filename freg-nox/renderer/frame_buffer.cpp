...
int r_FrameBuffer::Create( int depth_bits, int color_textures_number, unsigned int* color_tex_components, GLuint* color_tex_data_types, int size_x, int size_y )
{
    ...
    if( depth_bits )
    {
        ...
        glTexImage2D( GL_TEXTURE_2D, 0, depth_type, size_x, size_y, 0, GL_DEPTH_COMPONENT, GL_UNSIGNED_BYTE, NULL );
